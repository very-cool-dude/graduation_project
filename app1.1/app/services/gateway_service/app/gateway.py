...
logger.info("Сервис gateway запущен!")
...
AUTH_SERVICE_URL = "http://authorization_service:8002/verify"
REPORT_SERVICE_URL = "http://report_service:8003"
STT_SERVICE_URL = "http://transcriber_service:8004/transcribe"
LLM_SERVICE_URL = "http://generator_service:8005/generate"
